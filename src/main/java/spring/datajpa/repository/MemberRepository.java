...
import spring.datajpa.repository.dto.MemberProjection;
import spring.datajpa.repository.dto.UsernameOnly;
import spring.datajpa.repository.dto.UsernameOnlyDto;
...
public interface MemberRepository extends JpaRepository<Member, Long>, MemberRepositoryCustom {
    ...
    @Query("select new spring.datajpa.repository.dto.MemberDto(m.id, m.username, t.name) " +
